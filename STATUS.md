...
**Current phase:** Phase 4 in progress · UI scaffold + English live transcript working · **full live loop validated: Bluetooth system audio → Process Taps → harkd → WebSocket segments** · adding surfaces incrementally
